...
const headCells = [
  ...
  { id: 'fat', numeric: true, disablePadding: false, label: 'Midpoint' },
  { id: 'carbs', numeric: true, disablePadding: false, label: 'Ask' },
  { id: 'protein', numeric: true, disablePadding: false, label: 'Last' },
  { id: 'name', numeric: false, disablePadding: true, label: 'Volume' },
  { id: 'calories', numeric: true, disablePadding: false, label: 'Open Int' },
  { id: 'fat', numeric: true, disablePadding: false, label: 'Vol/IO' },
  { id: 'carbs', numeric: true, disablePadding: false, label: 'IV' },
  { id: 'protein', numeric: true, disablePadding: false, label: 'Last Trade' },
];
